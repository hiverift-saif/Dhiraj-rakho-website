          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">info@dhirajrakho.com</span>
              </div>
              <div className="flex items-center">
          ...
          <div>
            ...
            <div className="flex mb-6">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:border-blue-500"
              />
